			...
			<body>
				<div class="page-container">
					<div class="header-fragment">
						<a
							href="https://qwik-workers-header.web-experiments.workers.dev/"
							class="seam-link"
						>
							header
						</a>
					...
					<div class="body-fragment">
						<a
							href="https://qwik-workers-body.web-experiments.workers.dev/"
							class="seam-link"
						>
							body
						</a>
					...
					<div class="footer-fragment">
						<a
							href="https://qwik-workers-footer.web-experiments.workers.dev/"
							class="seam-link"
						>
							footer
						</a>
